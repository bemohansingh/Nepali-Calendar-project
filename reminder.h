...
np=evntlop/5;
    ...
    msg[138]=TTF_RenderText_Solid(font1,">> ADD REMINDER <<",textColor);
    else
    msg[138]=TTF_RenderText_Solid(font1,">> ADD REMINDER <<",textColor7);
    apply_surface(150,150,msg[138],screen);
//////////
 SDL_FreeSurface(msg[139]);
if(x>150 &&x < 405 && y>210 && y< 240)
    msg[139]=TTF_RenderText_Solid(font1,">> VIEW REMINDER <<",textColor);
    else
    msg[139]=TTF_RenderText_Solid(font1,">> VIEW REMINDER <<",textColor7);
     apply_surface(150,210,msg[139],screen);
///////
        SDL_FreeSurface(msg[140]);
if(x>150 &&x < 410 && y>270 && y< 300)
    msg[140]=TTF_RenderText_Solid(font1,">> EDIT REMINDER <<",textColor);
    else
     msg[140]=TTF_RenderText_Solid(font1,">> EDIT REMINDER <<",textColor7);
      apply_surface(150,270,msg[140],screen);
     //////
        SDL_FreeSurface(msg[141]);
     if(x>150 &&x < 430 && y>330 && y< 360)
    msg[141]=TTF_RenderText_Solid(font1,">> DELETE REMINDER <<",textColor);
    else
    msg[141]=TTF_RenderText_Solid(font1,">> DELETE REMINDER <<",textColor7);
...
apply_surface(110,340,msg[156],screen);
 ...
 SDL_FreeSurface(msg[1]);
    ...
    v[1]=48+mms[0].m%10;
    v[2]='\0';
    msg[0]=TTF_RenderText_Solid(font[0],"SET TIME <<      >>hour<<      >> in minute",textColor);
     setting[3]=TTF_RenderText_Solid(font[4],v,textColor1);
    apply_surface(337,75,setting[2],screen);
    apply_surface(421,75,setting[3],screen);
    apply_surface(248,75,msg[0],screen);
